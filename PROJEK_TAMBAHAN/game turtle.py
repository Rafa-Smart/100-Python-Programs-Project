...
create_new_ball_1()  # Start animation with one ball
create_new_ball_2()  # Start animation with two ball
create_new_ball_3()  # Start animation with three ball
